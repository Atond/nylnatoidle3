    ...
    regions: [
        ...
        // ==========================================
        {
            ...
            zones: [
                ...
                { id: 7, name: "Passage du Troll", description: "Tunnel hanté par un troll", icon: "👹", levelRange: { min: 16, max: 17 }, monsters: [ { id: 'troll_collines', name: 'Troll des collines', drops: [ { id: 'os_massif', name: 'Os massif' } ] }, { id: 'gobelin_forestier', name: 'Gobelin', drops: [ { id: 'champignon_commun', name: 'Champignon commun' } ] } ] },
                ...
                { id: 10, name: "Trône du Troll", description: "Tanière du roi troll", icon: "👑", levelRange: { min: 19, max: 20 }, monsters: [ { id: 'troll_collines', name: 'Troll des collines', drops: [ { id: 'os_massif', name: 'Os massif' } ] }, { id: 'golem_fissure', name: 'Golem de pierre', drops: [ { id: 'fragment_golem', name: 'Fragment de golem' } ] } ], isBossZone: true, bossSpawnLogic: "9_normal_then_boss" }
            ],
